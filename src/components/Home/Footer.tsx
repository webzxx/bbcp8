        ...
        <div className="flex flex-col lg:flex-row lg:justify-between items-center lg:items-start my-8 md:my-16 lg:space-x-8 space-y-16 lg:space-y-0">
          <div className="flex flex-col">
            <div className="max-w-xs">
              <p className="text-gray-800 leading-snug text-lg tracking-wide mb-6 opacity-60">
                Stay up to date with the Church.
              </p>

              <h6 className="text-current font-headline-sans font-bold text-xl lg:text-2xl tracking-tight leading-tighter ">
          ...
          <div className="flex-1 flex flex-col sm:flex-row sm:justify-between lg:justify-end w-full sm:w-auto max-w-sm sm:max-w-full mx-auto sm:space-x-8 xl:space-x-24 space-y-10 sm:space-y-0"></div>
        </div>
