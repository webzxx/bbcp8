    ...
    <section id="cta" className="fluid-container relative">
      <div className="bg-[#e2e3da] rounded-3xl px-6 sm:px-12 lg:px-0 flex flex-col-reverse lg:flex-row justify-center items-start">
        <div className="w-full lg:w-9/20 relative lg:-translate-y-10 pb-10 lg:pb-0 ">
          <h1 className="text-current font-headline-sans font-bold text-6xl lg:text-8xl xl:text-10xl tracking-tighter leading-none mb-3">
            Join Us
          </h1>
          ...
          <div className="lg:px-16">
            ...
            <p className="text-black leading-snug text-lg tracking-tighter mt-0 mb-8 last:mb-0 prose max-w-full lg:max-w-sm">
            ...
            <div className="relative inline-flex">
              <Button
                variant="default"
                className="inline-flex bg-sky-400 text-black hover:bg-blue-800 font-sans leading-none text-lg tracking-tighter py-7 px-14 rounded-4xl items-center justify-center gap-4 transition whitespace-nowrap select-none cursor-pointer"
              >
                Watch Online
              </Button>
            </div>
