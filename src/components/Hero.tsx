      ...
      >
        ...
        <div className="flex flex-col items-center text-center">
          <p className="text-white text-5xl font-semibold leading-tight mb-4">
            Shine as lights in the world, holding forth the <span className="text-sky-500">Word</span> of life
          </p>
          ...
          <div className="mt-10">
            <Button variant="outline" className="text-lg px-12 py-8 rounded-full bg-sky-500 border-none">Learn More</Button>
          </div>
        </div>
      </div>
      </div>
